...
<form action="CheckLogin" method=post>
    <div class="center-block" >
        ...
        <div class="form-inline">
            <input type="text" id="login" name="login" size="45" maxlength="45" pattern="\w{1,}@\w{3,}\.\w{2,4}" required title="Match email format no more then 45 symbols at least 6x+@3x+.2x(3x)">
        </div>
    </div>
    <div class="center-block" >
