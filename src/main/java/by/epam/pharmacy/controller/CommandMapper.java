...
import by.epam.pharmacy.command.medicine.*;
import by.epam.pharmacy.command.order.*;
import by.epam.pharmacy.command.payment.MakePaymentCommand;
import by.epam.pharmacy.command.payment.PayOrderCommand;
import by.epam.pharmacy.command.recipe.ApproveRecipeCommand;
import by.epam.pharmacy.command.recipe.DeleteRecipeCommand;
import by.epam.pharmacy.command.recipe.EditRecipeCommand;
import by.epam.pharmacy.command.recipe.RecipeListCommand;
import by.epam.pharmacy.command.user.*;
