...
public class SessionRequestContent {
    ...
    public void insertAttributes(HttpServletRequest request) {
        for (String key : requestAttributes.keySet()
            ...
            logger.info(key + requestAttributes.get(key));
            logger.info(request.getAttribute(key));
        }
        ...
        for (String key : sessionAttributes.keySet()
            ...
            logger.info(key + sessionAttributes.get(key));
            logger.info(request.getSession().getAttribute(key));
        }

        for (String key : requestParameters.keySet()
                ) {
            request.setAttribute(key, requestParameters.get(key));
            logger.info(key + requestParameters.get(key));
            logger.info(request.getAttribute(key));
        }
    }
