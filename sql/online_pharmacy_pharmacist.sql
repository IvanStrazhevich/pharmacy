...
(
    ...
    CONSTRAINT fk_pharmacist_client_id FOREIGN KEY (client_cl_id) REFERENCES client (user_id) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO online_pharmacy.pharmacist (user_id, ph_license_lic_id) VALUES (4, 1);
INSERT INTO online_pharmacy.pharmacist (user_id, ph_license_lic_id) VALUES (5, 2);