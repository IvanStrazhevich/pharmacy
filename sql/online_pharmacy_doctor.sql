...
(
    ...
    CONSTRAINT fk_doctor_client_id FOREIGN KEY (client_cl_id) REFERENCES client (user_id) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO online_pharmacy.doctor (user_id, dc_license_lic_id) VALUES (2, 1);
INSERT INTO online_pharmacy.doctor (user_id, dc_license_lic_id) VALUES (7, 2);